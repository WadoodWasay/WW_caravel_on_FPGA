## This file modified 7/31/2024 to change pins for the Arty A7-100T board
## (also works with the older Arty A7-35T board)
##

## Timing Constraints
# create_clock -add -name sys_clk_pin -period 83.333 -waveform {0 41.666} [get_ports {HCLK}] ;
# Name needs to correspond to what's passed to the get_clocks command?
create_clock -add -name HCLK -period 83.333 -waveform {0 41.666} [get_ports {HCLK}] ;

# Outputs
set_output_delay -clock [get_clocks HCLK] -min -add_delay 0.0   [get_ports {fsclk}];
set_output_delay -clock [get_clocks HCLK] -max -add_delay 8.333  [get_ports {fsclk}];
set_output_delay -clock [get_clocks HCLK] -min -add_delay 0.0   [get_ports {fcen}];
set_output_delay -clock [get_clocks HCLK] -max -add_delay 8.333  [get_ports {fcen}];
...
# Bidirectional
set_input_delay  -clock [get_clocks HCLK] -min -add_delay 0.0   [get_ports {fdio[*]}];
set_input_delay  -clock [get_clocks HCLK] -max -add_delay 8.333  [get_ports {fdio[*]}];
set_output_delay -clock [get_clocks HCLK] -min -add_delay 0.0   [get_ports {fdio[*]}];
set_output_delay -clock [get_clocks HCLK] -max -add_delay 8.333  [get_ports {fdio[*]}];


## 12 MHz Clock Signal
set_property PACKAGE_PIN E3 [get_ports { HCLK}]; #IO_L12P_T1_MRCC_14 Sch=gclk
...
## Buttons
set_property PACKAGE_PIN D9     [get_ports { RST }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
set_property IOSTANDARD LVCMOS33 [get_ports { RST }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { signal }]; #IO_L5N_T0_D07_14 Sch=ja[1]
#set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { UART_MASTER_TX }]; #IO_L4N_T0_D05_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { signal }]; #IO_L4N_T0_D05_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { fcen_Sys0_S0[0] }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { signal }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { fsclk_Sys0_S0[0] }]; #IO_L8P_T1_D11_14 Sch=ja[4]
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { fd_Sys0_S0[3] }]; #IO_L5P_T0_D06_14 Sch=ja[7]
#set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS33 } [get_ports { fd_Sys0_S0[2] }]; #IO_L4P_T0_D04_14 Sch=ja[8]
#set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { fd_Sys0_S0[1] }]; #IO_L6N_T0_D08_VREF_14 Sch=ja[9]
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { fd_Sys0_S0[0] }]; #IO_L8N_T1_D12_14 Sch=ja[10]
...
#set_property PACKAGE_PIN M3  [get_ports {fcen}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
#set_property PACKAGE_PIN M3  [get_ports {signal}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
...
set_property PACKAGE_PIN L13 [get_ports {fcen}]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property PACKAGE_PIN L16  [get_ports {fsclk}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property PACKAGE_PIN H1  [get_ports {signal}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property PACKAGE_PIN K17 [get_ports {fdio[0]}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property PACKAGE_PIN A15 [get_ports {signal}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property PACKAGE_PIN B15 [get_ports {fd_Sys0_S0[2]}]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property PACKAGE_PIN K18 [get_ports {fdio[1]}]; #IO_L6P_T0_16 Sch=pio[09]
#set_property PACKAGE_PIN A14 [get_ports {signal}]; #IO_L6P_T0_16 Sch=pio[09]
set_property PACKAGE_PIN L14  [get_ports {fdio[2]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
#set_property PACKAGE_PIN J3  [get_ports {signal}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property PACKAGE_PIN M14  [get_ports {fdio[3]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
#set_property PACKAGE_PIN J1  [get_ports {signal}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
 
#set_property PACKAGE_PIN K2  [get_ports {UART_MASTER_RX}]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
#set_property PACKAGE_PIN L1  [get_ports {UART_MASTER_TX}]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property PACKAGE_PIN L2  [get_ports {RX_out}]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
...
# set_property PACKAGE_PIN W2 [get_ports { NMI }]; #IO_L5N_T0_34 Sch=pio[32]
 ...
 #set_property PACKAGE_PIN U1 [get_ports { signal }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
 #set_property PACKAGE_PIN W2 [get_ports { UART_MASTER_TX }]; #IO_L5N_T0_34 Sch=pio[32]
 #set_property PACKAGE_PIN W2 [get_ports { signal }]; #IO_L5N_T0_34 Sch=pio[32]
 #set_property PACKAGE_PIN G17 [get_ports { HCLK_out }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
...
#set_property IOSTANDARD LVCMOS33  [get_ports {signal}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property IOSTANDARD LVCMOS33  [get_ports {fcen}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
...
set_property IOSTANDARD LVCMOS33  [get_ports {fsclk}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property IOSTANDARD LVCMOS33  [get_ports {signal}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property IOSTANDARD LVCMOS33 [get_ports {fdio[0]}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property IOSTANDARD LVCMOS33 [get_ports {signal}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[2]}]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property IOSTANDARD LVCMOS33 [get_ports {fdio[1]}]; #IO_L6P_T0_16 Sch=pio[09]
#set_property IOSTANDARD LVCMOS33 [get_ports {signal}]; #IO_L6P_T0_16 Sch=pio[09]
set_property IOSTANDARD LVCMOS33  [get_ports {fdio[2]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
#set_property IOSTANDARD LVCMOS33  [get_ports {signal}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property IOSTANDARD LVCMOS33  [get_ports {fdio[3]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
#set_property IOSTANDARD LVCMOS33  [get_ports {signal}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]

set_property IOSTANDARD LVCMOS33  [get_ports { UART_MASTER_RX}]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
set_property IOSTANDARD LVCMOS33  [get_ports { UART_MASTER_TX}]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property IOSTANDARD LVCMOS33  [get_ports {RX_out}]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
...
#set_property IOSTANDARD LVCMOS33 [get_ports { signal }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
#set_property IOSTANDARD LVCMOS33 [get_ports { signal }]; #IO_L5N_T0_34 Sch=pio[32]
...
## UART
set_property PACKAGE_PIN A9 [get_ports { UART_MASTER_TX }]; #IO_L7N_T1_D10_14 Sch=uart_rxd_out
set_property PACKAGE_PIN D10 [get_ports { UART_MASTER_RX }]; #IO_L7P_T1_D09_14 Sch=uart_txd_in
