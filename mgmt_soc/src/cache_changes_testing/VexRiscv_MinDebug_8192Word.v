...
// MODIFIED BY WADOOD 12/2/2025 for 4096-byte instruction cache
...
`endif
  ...
  // Hack---Initialize mcycle and minstret (because registers were
  // moved to the input/output list)
  // always @(posedge clk) begin
  //   if(reset) begin
...
module InstructionCache (
  ...
  reg        [18:0]   _zz_ways_0_tags_port1;	// 19 -> 18
  wire       [18:0]   _zz_ways_0_tags_port;	// 19 -> 18
  reg                 _zz_1;
  reg                 _zz_2;
  reg                 lineLoader_fire;
  ...
  reg        [10:0]    lineLoader_flushCounter;		// 9 -> 10	
  ...
  wire       [9:0]    lineLoader_write_tag_0_payload_address;		// 8 -> 9
  wire                lineLoader_write_tag_0_payload_data_valid;
  wire                lineLoader_write_tag_0_payload_data_error;
  wire       [16:0]   lineLoader_write_tag_0_payload_data_address;	// 17 -> 16
  wire                lineLoader_write_data_0_valid;
  wire       [12:0]    lineLoader_write_data_0_payload_address;		// 11 -> 12
  wire       [31:0]   lineLoader_write_data_0_payload_data;
  wire                when_InstructionCache_l401;
  wire       [12:0]    _zz_fetchStage_read_banksValue_0_dataMem;		// 11 -> 12
  wire                _zz_fetchStage_read_banksValue_0_dataMem_1;
  wire       [31:0]   fetchStage_read_banksValue_0_dataMem;
  wire       [31:0]   fetchStage_read_banksValue_0_data;
  wire       [9:0]    _zz_fetchStage_read_waysValues_0_tag_valid;	// 8 -> 9
  wire                _zz_fetchStage_read_waysValues_0_tag_valid_1;
  wire                fetchStage_read_waysValues_0_tag_valid;
  wire                fetchStage_read_waysValues_0_tag_error;
  wire       [16:0]   fetchStage_read_waysValues_0_tag_address;		// 17 -> 16
  wire       [18:0]   _zz_fetchStage_read_waysValues_0_tag_valid_2;	// 19 -> 18
  ...
  (* ram_style = "block" *) reg [31:0] banks_0 [0:8191];
  (* ram_style = "block" *) reg [27:0] ways_0_tags [0:1023];
  ...
  assign when_InstructionCache_l338 = (! lineLoader_flushCounter[10]);		// 9 -> 10
  ...
  assign lineLoader_write_tag_0_valid = ((1'b1 && lineLoader_fire) || (! lineLoader_flushCounter[10]));	// 9 -> 10
  assign lineLoader_write_tag_0_payload_address = (lineLoader_flushCounter[10] ? lineLoader_address[14 : 5] : lineLoader_flushCounter[9 : 0]);	// 9 -> 10, 13:5 -> 14:5,  8:0 -> 9:0
  assign lineLoader_write_tag_0_payload_data_valid = lineLoader_flushCounter[10];	// 9 -> 8
  assign lineLoader_write_tag_0_payload_data_error = (lineLoader_hadError || io_mem_rsp_payload_error);
  assign lineLoader_write_tag_0_payload_data_address = lineLoader_address[31 : 14];	// 31:13 -> 31:14
  assign lineLoader_write_data_0_valid = (io_mem_rsp_valid && 1'b1);
  assign lineLoader_write_data_0_payload_address = {lineLoader_address[14 : 5],lineLoader_wordIndex};	// 13:5 -> 14:5
  assign lineLoader_write_data_0_payload_data = io_mem_rsp_payload_data;
  assign when_InstructionCache_l401 = (lineLoader_wordIndex == 3'b111);
  assign _zz_fetchStage_read_banksValue_0_dataMem = io_cpu_prefetch_pc[14 : 2];	// 13:2 -> 14:2
  assign _zz_fetchStage_read_banksValue_0_dataMem_1 = (! io_cpu_fetch_isStuck);
  assign fetchStage_read_banksValue_0_dataMem = _zz_banks_0_port1;
  assign fetchStage_read_banksValue_0_data = fetchStage_read_banksValue_0_dataMem[31 : 0];
  assign _zz_fetchStage_read_waysValues_0_tag_valid = io_cpu_prefetch_pc[14 : 5];	// 13:5 -> 14:5
  assign _zz_fetchStage_read_waysValues_0_tag_valid_1 = (! io_cpu_fetch_isStuck);
  assign _zz_fetchStage_read_waysValues_0_tag_valid_2 = _zz_ways_0_tags_port1;
  assign fetchStage_read_waysValues_0_tag_valid = _zz_fetchStage_read_waysValues_0_tag_valid_2[0];
  assign fetchStage_read_waysValues_0_tag_error = _zz_fetchStage_read_waysValues_0_tag_valid_2[1];
  assign fetchStage_read_waysValues_0_tag_address = _zz_fetchStage_read_waysValues_0_tag_valid_2[18 : 2];		// 19:2 -> 18:2
  assign fetchStage_hit_hits_0 = (fetchStage_read_waysValues_0_tag_valid && (fetchStage_read_waysValues_0_tag_address == io_cpu_fetch_mmuRsp_physicalAddress[31 : 14]));	// 31:13 -> 31:14
  ...
  always @(posedge clk) begin
    ...
    _zz_when_InstructionCache_l342 <= lineLoader_flushCounter[10];	// 9 -> 10
    if(when_InstructionCache_l351) begin
...
// 2048 Words --> 4096 Words cache size
