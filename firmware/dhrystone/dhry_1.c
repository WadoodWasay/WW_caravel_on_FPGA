...
//  ======= set each IO to the desired configuration =============
    ...
    // GPIO 0 is turned off to prevent toggling the debug pin; For debug,
    // make this an output and drive it externally to ground.

    reg_mprj_io_0 = GPIO_MODE_MGMT_STD_ANALOG;

    // Changing configuration for IO[1-4] will interfere with programming flash.
    // if you change them, you may need to hold reset while powering up the
    // board and initiating flash to keep the process configuring these IO from
