...
module InstructionCache (
  ...
  reg        [19:0]   _zz_ways_0_tags_port1;	// 20 -> 19
  wire       [19:0]   _zz_ways_0_tags_port;	// 20 -> 19
  reg                 _zz_1;
  reg                 _zz_2;
  reg                 lineLoader_fire;
  ...
  reg        [9:0]    lineLoader_flushCounter;		// 8 -> 9	
  ...
  wire       [8:0]    lineLoader_write_tag_0_payload_address;		// 7 -> 8
  wire                lineLoader_write_tag_0_payload_data_valid;
  wire                lineLoader_write_tag_0_payload_data_error;
  wire       [17:0]   lineLoader_write_tag_0_payload_data_address;	// 18 -> 17
  wire                lineLoader_write_data_0_valid;
  wire       [11:0]    lineLoader_write_data_0_payload_address;		// 10 -> 11
  wire       [31:0]   lineLoader_write_data_0_payload_data;
  wire                when_InstructionCache_l401;
  wire       [11:0]    _zz_fetchStage_read_banksValue_0_dataMem;		// 10 -> 11
  wire                _zz_fetchStage_read_banksValue_0_dataMem_1;
  wire       [31:0]   fetchStage_read_banksValue_0_dataMem;
  wire       [31:0]   fetchStage_read_banksValue_0_data;
  wire       [8:0]    _zz_fetchStage_read_waysValues_0_tag_valid;	// 7 -> 8
  wire                _zz_fetchStage_read_waysValues_0_tag_valid_1;
  wire                fetchStage_read_waysValues_0_tag_valid;
  wire                fetchStage_read_waysValues_0_tag_error;
  wire       [17:0]   fetchStage_read_waysValues_0_tag_address;		// 18 -> 17
  wire       [19:0]   _zz_fetchStage_read_waysValues_0_tag_valid_2;	// 20 -> 19
  ...
  (* ram_style = "block" *) reg [31:0] banks_0 [0:4095];
  (* ram_style = "block" *) reg [27:0] ways_0_tags [0:511];
  ...
  assign when_InstructionCache_l338 = (! lineLoader_flushCounter[9]);		// 8 -> 9
  ...
  assign lineLoader_write_tag_0_valid = ((1'b1 && lineLoader_fire) || (! lineLoader_flushCounter[9]));	// 8 -> 9
  assign lineLoader_write_tag_0_payload_address = (lineLoader_flushCounter[9] ? lineLoader_address[13 : 5] : lineLoader_flushCounter[8 : 0]);	// 8 -> 9, 12:5 -> 13:5,  7:0 -> 8:0
  assign lineLoader_write_tag_0_payload_data_valid = lineLoader_flushCounter[9];	// 8 -> 9
  assign lineLoader_write_tag_0_payload_data_error = (lineLoader_hadError || io_mem_rsp_payload_error);
  assign lineLoader_write_tag_0_payload_data_address = lineLoader_address[31 : 13];	// 31:12 -> 31:13
  assign lineLoader_write_data_0_valid = (io_mem_rsp_valid && 1'b1);
  assign lineLoader_write_data_0_payload_address = {lineLoader_address[13 : 5],lineLoader_wordIndex};	// 12:5 -> 13:5
  assign lineLoader_write_data_0_payload_data = io_mem_rsp_payload_data;
  assign when_InstructionCache_l401 = (lineLoader_wordIndex == 3'b111);
  assign _zz_fetchStage_read_banksValue_0_dataMem = io_cpu_prefetch_pc[13 : 2];	// 12:2 -> 13:2
  assign _zz_fetchStage_read_banksValue_0_dataMem_1 = (! io_cpu_fetch_isStuck);
  assign fetchStage_read_banksValue_0_dataMem = _zz_banks_0_port1;
  assign fetchStage_read_banksValue_0_data = fetchStage_read_banksValue_0_dataMem[31 : 0];
  assign _zz_fetchStage_read_waysValues_0_tag_valid = io_cpu_prefetch_pc[13 : 5];	// 12:5 -> 13:5
  assign _zz_fetchStage_read_waysValues_0_tag_valid_1 = (! io_cpu_fetch_isStuck);
  assign _zz_fetchStage_read_waysValues_0_tag_valid_2 = _zz_ways_0_tags_port1;
  assign fetchStage_read_waysValues_0_tag_valid = _zz_fetchStage_read_waysValues_0_tag_valid_2[0];
  assign fetchStage_read_waysValues_0_tag_error = _zz_fetchStage_read_waysValues_0_tag_valid_2[1];
  assign fetchStage_read_waysValues_0_tag_address = _zz_fetchStage_read_waysValues_0_tag_valid_2[19 : 2];		// 20:2 -> 19:2
  ...
  always @(posedge clk) begin
    ...
    _zz_when_InstructionCache_l342 <= lineLoader_flushCounter[9];	// 8 -> 9
    if(when_InstructionCache_l351) begin
