...
module InstructionCache (
  ...
  reg        [25:0]   _zz_ways_0_tags_port1;	// 24 -> 25
  wire       [25:0]   _zz_ways_0_tags_port;	// 24 -> 25
  reg                 _zz_1;
  reg                 _zz_2;
  reg                 lineLoader_fire;
  ...
  reg        [3:0]    lineLoader_flushCounter;		// 4 -> 3	
  ...
  wire       [2:0]    lineLoader_write_tag_0_payload_address;		// 3 -> 2
  wire                lineLoader_write_tag_0_payload_data_valid;
  wire                lineLoader_write_tag_0_payload_data_error;
  wire       [23:0]   lineLoader_write_tag_0_payload_data_address;	// 22 -> 23
  wire                lineLoader_write_data_0_valid;
  wire       [5:0]    lineLoader_write_data_0_payload_address;		// 6 -> 5
  wire       [31:0]   lineLoader_write_data_0_payload_data;
  wire                when_InstructionCache_l401;
  wire       [5:0]    _zz_fetchStage_read_banksValue_0_dataMem;		// 6 -> 5
  wire                _zz_fetchStage_read_banksValue_0_dataMem_1;
  wire       [31:0]   fetchStage_read_banksValue_0_dataMem;
  wire       [31:0]   fetchStage_read_banksValue_0_data;
  wire       [2:0]    _zz_fetchStage_read_waysValues_0_tag_valid;	// 3 -> 2
  wire                _zz_fetchStage_read_waysValues_0_tag_valid_1;
  wire                fetchStage_read_waysValues_0_tag_valid;
  wire                fetchStage_read_waysValues_0_tag_error;
  wire       [23:0]   fetchStage_read_waysValues_0_tag_address;		// 22 -> 23
  wire       [25:0]   _zz_fetchStage_read_waysValues_0_tag_valid_2;	// 24 -> 25
  ...
  assign when_InstructionCache_l338 = (! lineLoader_flushCounter[3]);		// 4 -> 3
  ...
  assign lineLoader_write_tag_0_valid = ((1'b1 && lineLoader_fire) || (! lineLoader_flushCounter[3]));	// 4 -> 3
  assign lineLoader_write_tag_0_payload_address = (lineLoader_flushCounter[3] ? lineLoader_address[7 : 5] : lineLoader_flushCounter[2 : 0]);	// 4 -> 3, 8:5 -> 7:5,  3:0 -> 2:0
  assign lineLoader_write_tag_0_payload_data_valid = lineLoader_flushCounter[3];	// 4 -> 3
  assign lineLoader_write_tag_0_payload_data_error = (lineLoader_hadError || io_mem_rsp_payload_error);
  assign lineLoader_write_tag_0_payload_data_address = lineLoader_address[31 : 8];	// 31:9 -> 31:8
  assign lineLoader_write_data_0_valid = (io_mem_rsp_valid && 1'b1);
  assign lineLoader_write_data_0_payload_address = {lineLoader_address[7 : 5],lineLoader_wordIndex};	// 8:5 -> 7:5
  assign lineLoader_write_data_0_payload_data = io_mem_rsp_payload_data;
  assign when_InstructionCache_l401 = (lineLoader_wordIndex == 3'b111);
  assign _zz_fetchStage_read_banksValue_0_dataMem = io_cpu_prefetch_pc[7 : 2];	// 8:2 -> 7:2
  assign _zz_fetchStage_read_banksValue_0_dataMem_1 = (! io_cpu_fetch_isStuck);
  assign fetchStage_read_banksValue_0_dataMem = _zz_banks_0_port1;
  assign fetchStage_read_banksValue_0_data = fetchStage_read_banksValue_0_dataMem[31 : 0];
  assign _zz_fetchStage_read_waysValues_0_tag_valid = io_cpu_prefetch_pc[7 : 5];	// 8:5 -> 7:5
  assign _zz_fetchStage_read_waysValues_0_tag_valid_1 = (! io_cpu_fetch_isStuck);
  assign _zz_fetchStage_read_waysValues_0_tag_valid_2 = _zz_ways_0_tags_port1;
  assign fetchStage_read_waysValues_0_tag_valid = _zz_fetchStage_read_waysValues_0_tag_valid_2[0];
  assign fetchStage_read_waysValues_0_tag_error = _zz_fetchStage_read_waysValues_0_tag_valid_2[1];
  assign fetchStage_read_waysValues_0_tag_address = _zz_fetchStage_read_waysValues_0_tag_valid_2[25 : 2];		// 24:2 -> 25:2
  assign fetchStage_hit_hits_0 = (fetchStage_read_waysValues_0_tag_valid && (fetchStage_read_waysValues_0_tag_address == io_cpu_fetch_mmuRsp_physicalAddress[31 : 8]));	// 31:9 -> 31:8
  ...
  always @(posedge clk) begin
    ...
    _zz_when_InstructionCache_l342 <= lineLoader_flushCounter[3];	// 4 -> 3
    if(when_InstructionCache_l351) begin
...
// This is going from 128 Words to 64 Words
